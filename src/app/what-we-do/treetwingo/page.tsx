    ...
    <>
      ...
      <div className="bg-[#F6F4DE] min-h-screen">
        ...
        <div className="pl-20 text-[#505A28] text-[15pt] font-semibold">
          <p>
            The Tree-Go-Twin Project is an innovative conservation initiative by
            Sembeza Africa, designed to inspire environmental stewardship among
            children while fostering global connections. This program pairs
            Ugandan children with international peers to plant, nurture, and
            care for trees, promoting sustainable living and a shared sense of
        ...
        <div className="pl-20 text-[#505A28] text-[15pt] font-semibold">
          ...
          <p>
            2. <strong>Twinning Across Borders:</strong> Each child is paired
            with an international peer, creating a unique partnership. They
            share their tree-growing journey through photos, letters, and
            videos.
          </p>
          <p>
            3. <strong>Environmental Education: </strong>Children learn about
            the importance of trees in mitigating climate change, conserving
        ...
        <div className="pl-20 text-[#505A28] text-[15pt] font-semibold">
          <p>
            <strong>.</strong> Increased awareness of environmental conservation
          ...
          <p>
            <strong>.</strong> Active participation in reforestation efforts,
        ...
        <div className="pl-20 text-[#505A28] text-[15pt] font-semibold">
          ...
          <p>
            <strong>.</strong> Partner: Join us as a school, organization, or
            corporate sponsor to expand our reach.
          </p>
          <p>
            <strong>.</strong> Volunteer: Help us engage communities and ensure
        ...
        <div className="pl-20 text-[#505A28] text-[15pt] font-semibold">
          <p>
            ...
            trees—you’re nurturing young minds, fostering global friendships,
            and contributing to a healthier planet for generations to come.
          </p>
        </div>
      </div>
    </>
